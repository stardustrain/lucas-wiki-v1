const sidebarConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      [
        "/code-review/02.the-standard-of-code-review",
        "2. The Standard of Code Review"
      ],
      [
        "/code-review/03.what-to-look-for-in-a-code-review",
        "3. What to look for in a code review"
      ],
      [
        "/code-review/04.navigating-a-CL-in-review",
        "4. Navigating a CL in review"
      ],
      ["/code-review/05.speed-of-code-reviews", "5. Speed of Code Reviews"],
      [
        "/code-review/06.how-to-write-code-review-comments",
        "6. How to write code review comments"
      ],
      [
        "/code-review/07.handling-pushback-in-code-reviews",
